...
export function ChangePassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = `${process.env.REACT_APP_URL}/change-password`;
        ...
        <div className='d-flex'>
            <div className='login-side'>
                <div className='container'>
                    <p className='login-title'>Change <br />Password</p>
            ...
            <div className='login-main'>
                <h2 className='d-md-none d-block'>Change Password</h2>
                <div className='container d-flex justify-content-center align-items-center'>
                    <form onSubmit={handleSubmit}>
                        <div>
                            <label htmlFor="currentPassword" className="login-type mt-3">Current Password</label>
                            <input
                            ...
                            <div className="flex items-center mt-1">
                                <input
                                    ...
                                    className="mr-2"
                                />
                                <label htmlFor="showCurrentPassword" className="text-sm ms-2 mt-2">Show Current Password</label>
                            </div>
