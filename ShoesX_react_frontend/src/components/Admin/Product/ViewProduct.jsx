            ...
            <div className='view-product-body body-bg'>
                <div className="row">
                    <div className="col-lg-6 col-md-12">
                        <img alt="product" className='img-fluid' src={`${import.meta.env.VITE_REACT_APP_IMAGE}/${state?.brand?.image}`} />
                        <div className='img-child'>
                            ...
                            >
                                ...
                                <SwiperSlide className='swiper-img'>
                                    <img
                                        src={`${import.meta.env.VITE_REACT_APP_IMAGE}${state.brand.image}`}
                                        alt='product'
                                        className='img-fluid'
                                    />
                                </SwiperSlide>
